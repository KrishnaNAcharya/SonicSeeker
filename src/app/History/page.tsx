            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    <div className="flex rounded-lg overflow-hidden border">
                        <button
                            className={`px-4 py-2 text-sm ${activeTab === 'all' ? 'bg-blue-500 text-white' : 'bg-white hover:bg-gray-50'}`}
                            onClick={() => setActiveTab('all')}
                        >
                            All
                        </button>
                        <button
                            className={`px-4 py-2 text-sm border-l ${activeTab === 'audio' ? 'bg-blue-500 text-white' : 'bg-white hover:bg-gray-50'}`}
                            onClick={() => setActiveTab('audio')}
                        >
                            Audio
                        </button>
                        <button
                            className={`px-4 py-2 text-sm border-l ${activeTab === 'video' ? 'bg-blue-500 text-white' : 'bg-white hover:bg-gray-50'}`}
